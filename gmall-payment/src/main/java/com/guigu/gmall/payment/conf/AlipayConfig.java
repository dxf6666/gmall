package com.guigu.gmall.payment.conf;
 ...
 * @return
 */
@Configuration  // 配置类，springboot在启动的时候，会加载该配置文件
@PropertySource("classpath:alipay.properties")//@PropertySource从resource目录下加载.properties源文件
public class AlipayConfig {

    @Value("${alipay_url}")  //@Value("${键}") 根据key获取配置文件中的数据,并赋值给该字段
    ...
    @Value("${alipay_public_key}")  //@Value 将值作为参数 传入
    ...
    @Bean  // 实例化alipayClient  -- 支付宝需要许多参数
